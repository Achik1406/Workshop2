...
import com.example.goldendreamsbowling.JavaFile.MugAdapter;
...
public class Mug_page extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    RecyclerView recyclerView;
    FloatingActionButton floatingActionButton;
    List<productModel> productModels;
    MugAdapter mugAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager layoutManager = new GridLayoutManager(Mug_page.this,2);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Mug_page.this, CartActivity.class));
                finish();
            }
        });
    }
    ...
    private void getProducts() {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Cup");
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot :snapshot.getChildren()){
                    ...
                    mugAdapter = new MugAdapter(Mug_page.this,productModels,floatingActionButton);
                    recyclerView.setAdapter(mugAdapter);
