...
public class CapAdapter extends RecyclerView.Adapter<CapAdapter.MyViewHolder> {
    ...
    public CapAdapter(Context context, List<productModel> productModels, FloatingActionButton floatingActionButton) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CapAdapter.MyViewHolder(view);
    }
