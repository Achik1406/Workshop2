...
public class TotebagAdapter extends RecyclerView.Adapter<TotebagAdapter.MyViewHolder> {
    ...
    public TotebagAdapter(Context context, List<productModel> productModels, FloatingActionButton floatingActionButton) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new TotebagAdapter.MyViewHolder(view);
    }
