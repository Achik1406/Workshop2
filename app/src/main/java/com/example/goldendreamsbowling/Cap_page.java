...
import com.example.goldendreamsbowling.JavaFile.CapAdapter;
...
public class Cap_page extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager layoutManager = new GridLayoutManager(Cap_page.this,2);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Cap_page.this, CartActivity.class));
                finish();
            }
        });
    }
    ...
    private void getProducts() {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Cap");
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot :snapshot.getChildren()){
                    ...
                    capAdapter = new CapAdapter(Cap_page.this,productModels,floatingActionButton);
